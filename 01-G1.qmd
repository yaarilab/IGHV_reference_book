...
```{r}
allele_appearance(data_frac, g_group)
```
...
```{r}
tagList(sequence_depth(data_frac, g_group, allele_db))
```
...
```{=html}
 <iframe id="example1" src=" https://peresay.shinyapps.io/absolute_usage_app/?g_group=%22IGHVF5-G30%22" style="border: none; width: 100%; height: 720px" frameborder="0"></iframe>
```
