---
title: 'IGHV3-30-5/IGHV3-30/IGHV3-33/IGHV3-30-3'
execute:
  echo: false
  warning: false
  message: false
...
```{=html}
 <iframe id="example1" src=" https://peresay.shinyapps.io/absolute_usage_app/?g_group=%22IGHVF2-G14%22" style="border: none; width: 100%; height: 720px" frameborder="0"></iframe>
```
